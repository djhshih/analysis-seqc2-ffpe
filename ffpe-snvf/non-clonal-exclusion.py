...
## SNVF Non-Clonal Filtering
filter_dataset(
	dataset = "FFX", 
    source_variant_set = "mutect2-tn_filtered_pass-orientation-dp20-blacklist",
    new_variant_set = "mutect2-tn_filtered_pass-orientation-dp20-blacklist-clonal"
)

filter_dataset(
	dataset = "FFX", 
    source_variant_set = "mutect2-tn_filtered_pass-orientation-exome-dp20-blacklist",
    new_variant_set = "mutect2-tn_filtered_pass-orientation-exome-dp20-blacklist-clonal"
)
