...
regions="../../data/release/v1.2.1/High-Confidence_Regions_v1.2.bed"

for vcf in ../mutect2-matched-normal_exome-target_pass-orientation-dp-filtered/{WES,FFX}/*/*.vcf; do
